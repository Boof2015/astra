...
export const ASTRA_LOGO_MAIN_FILL_CSS = 'hsl(var(--accent-h) calc(var(--accent-sat-scale, 1) * 100%) 50%)'
export const ASTRA_LOGO_SHADOW_FILL_CSS = 'hsl(var(--accent-h) calc(var(--accent-sat-scale, 1) * 40%) 14%)'
