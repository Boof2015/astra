...
export const ALBUM_SORT_STATE_STORAGE_KEY = 'astra-library-album-sort-state-v1'
export const ROOT_TRACK_TABLE_LAYOUT_STORAGE_KEY = 'astra-library-root-track-table-layout-v1'
...
export const PLAYLIST_BROWSER_SORT_STORAGE_KEY = 'astra-playlist-browser-sort-v1'
export const PLAYLIST_SIDEBAR_PINS_STORAGE_KEY = 'astra-playlist-sidebar-pins-v1'
...
export const SOURCE_SPEAKER_ROUTING_STORAGE_KEY = 'astra-audio-source-speaker-routing-v1'
export const SPEAKER_PROFILES_STORAGE_KEY = 'astra-audio-speaker-profiles-v1'
