import {
  ...
  SOURCE_SPEAKER_ROUTING_STORAGE_KEY,
  SPEAKER_PROFILES_STORAGE_KEY,
...
const SETTINGS_TRANSFER_CATEGORY_DEFINITIONS_INTERNAL: SettingsTransferCategoryDefinition[] = [
  ...
  },
  {
    id: 'library_view',
    label: 'Library View',
    description: 'Artist and album browsing, root Tracks table layout, and detail tracklist columns.',
  },
  {
